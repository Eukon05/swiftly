...
public class BankControllerAdvice {
    ...
    private static final ResultDTO DELETE_DATA_MISMATCH_DTO = new ResultDTO(DELETE_DATA_MISMATCH);
    ...
    @ExceptionHandler(DeleteDataMismatchException.class)
    public ResponseEntity<ResultDTO> handleDeleteDataMismatch() {
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(DELETE_DATA_MISMATCH_DTO);
    }
